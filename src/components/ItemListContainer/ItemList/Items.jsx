...
const Items = ({item, onAdd}) => {

const {key, titulo, img, descriptions, stock} = item;
    ...
    <CardGroup>
      ...
      <Card.Img variant="top" src={img} style={{maxWidth: "200px",  maxHeight: "200px"}}/>
        <Card.Body>
          ...
          <Button id="ButtonDetails" variant="light" onClick={() => onAdd(counter)}>Ver Detalles del producto</Button>
        </Card.Body>
